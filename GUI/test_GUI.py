...
#    Jul 09, 2020 08:06:54 AM BST  platform: Linux
...
class GUI:
    def __init__(self, top=None):
        ...
        self.lb_Trq.place(relx=0.514, rely=0.586, height=31, width=70
                , bordermode='ignore')
        self.lb_Trq.configure(activebackground="#f9f9f9")
        self.lb_Trq.configure(background="#a0d8ba")
        self.lb_Trq.configure(cursor="fleur")
        ...
        self.lb_Lock = tk.Label(self.Labelframe1)
        self.lb_Lock.place(relx=0.525, rely=0.204, height=31, width=70
                , bordermode='ignore')
        self.lb_Lock.configure(activebackground="#f9f9f9")
        self.lb_Lock.configure(background="#a0d8ba")
        self.lb_Lock.configure(cursor="fleur")
        self.lb_Lock.configure(font="-family {DejaVu Sans} -size 13 -weight normal -slant roman -underline 0 -overstrike 0")
        self.lb_Lock.configure(text='''Lock''')

        self.la_Acc = tk.Label(self.Labelframe1)
        self.la_Acc.place(relx=0.04, rely=0.591, height=31, width=70
                , bordermode='ignore')
        ...
        self.en_Trq.place(relx=0.629, rely=0.538, height=43, relwidth=0.327
                , bordermode='ignore')
        self.en_Trq.configure(background="white")
        self.en_Trq.configure(cursor="fleur")
        ...
        self.en_Acc.place(relx=0.151, rely=0.538, height=43, relwidth=0.327
                , bordermode='ignore')
        ...
        self.rdBtn_Mode_Spt.place(relx=0.48, rely=0.121, relheight=0.052
        ...
        self.en_SpdLim = tk.Entry(self.Labelframe1_6)
        self.en_SpdLim.place(relx=0.256, rely=0.281, height=33, relwidth=0.677
                , bordermode='ignore')
        self.en_SpdLim.configure(background="white")
        self.en_SpdLim.configure(font="TkFixedFont")
        self.en_SpdLim.configure(selectbackground="#c4c4c4")

        self.lb_Mode = tk.Label(self.Labelframe1_6)
        self.lb_Mode.place(relx=0.103, rely=0.112, height=31, width=80
                , bordermode='ignore')
        ...
        self.lb_SpdLim = tk.Label(self.Labelframe1_6)
        self.lb_SpdLim.place(relx=0.048, rely=0.285, height=31, width=120
                , bordermode='ignore')
        self.lb_SpdLim.configure(activebackground="#f9f9f9")
        self.lb_SpdLim.configure(background="#a3f9ff")
        self.lb_SpdLim.configure(font="-family {DejaVu Sans} -size 13 -weight normal -slant roman -underline 0 -overstrike 0")
        self.lb_SpdLim.configure(text='''Speed Limit''')

        self.Label1_1 = tk.Label(self.Labelframe1_6)
        self.Label1_1.place(relx=0.102, rely=0.461, height=31, width=70
                , bordermode='ignore')
        ...
        self.Scale1.place(relx=0.246, rely=0.429, relwidth=0.706, relheight=0.0
        ...
        self.btn_Lock_5.place(relx=0.684, rely=0.674, height=101, width=151
                , bordermode='ignore')
        ...
        self.Labelframe1_7.configure(cursor="fleur")
